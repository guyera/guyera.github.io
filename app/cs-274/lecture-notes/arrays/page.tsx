...
import { generateMD } from '../ui/mdregistry'
...
const allPathData = sourcesByNamedIdentifier
...
export default async function Page({ params }: any) {
  var lectureNotesNode = contents
  var md = generateMD(lectureNotesNode)
  console.log(md)
  return (
    <>
