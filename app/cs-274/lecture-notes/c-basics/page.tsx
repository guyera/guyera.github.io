...
==1127744== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)`
      ...
      <P>However, I write "true" and "false" in quotation marks for a reason: as strange as it may sound, older versions of C do not have a dedicated boolean data type (the <Code>_Bool</Code> type was introduced later in C99, along with some convenience macros provided by <Code>stdbool.h</Code>; many legacy codebases still use C89). Instead, historical C code uses integers to represent true and false values. Relational operations will produce a value of 1 when the relationship is true, and a value of 0 when the relationship is false.</P>
