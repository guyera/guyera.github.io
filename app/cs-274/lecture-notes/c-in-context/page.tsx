...
async function LectureNotes({ allPathData }: { allPathData: any }) {
  return (
    <>
      ...
      <P>(These sorts of bugs can be extremely dangerous. Microsoft <Link href="https://www.microsoft.com/en-us/msrc/blog/2019/07/a-proactive-approach-to-more-secure-code">reported in 2019</Link> that 70% of their vulnerabilities that they assigned a CVE were due to memory safety issues of languages like C and C++. Also, many historically prominent security vulnerabilities have been due to memory safety issues, including <Link href="https://www.heartbleed.com/">Heartbleed</Link>. And if you're a gamer, you might remember that much of the Dark Souls franchise went offline for about a year and a half starting in 2022<Emdash/>that was because of a memory management bug in the franchsise's matchmaking system, also due to memory safety issues of languages like C and C++.)</P>
