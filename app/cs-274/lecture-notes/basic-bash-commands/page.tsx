...
`cd cs-274`
      ...
      <ShellBlock copyable={false}>{
`(base) guyera@flip1:cs-274$ pwd
/nfs/stak/users/guyera/cs-274`
      }</ShellBlock>

      <P>Since we're creating directories, let's create some more to help you organize your work for this class. Inside your <Code>cs-274</Code> directory (which is currently your working directory), create an <Code>assignments</Code> directory and a <Code>labs</Code> directory:</P>
