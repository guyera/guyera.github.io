...
`
      ...
      <P>In your terminal, <Code>ls</Code> may display <Code>hello-world</Code> in green text. This indicates that it's an executable file (<Link href="#executable-file-permissions">more on executable file permissions in a bit</Link>). In other words, it's 1) expressed in terms of the computer's machine code language, and 2) contains the necessary metadata and other information for the operating system's program loader to be able to load it and execute it (e.g., as in <Link href="https://en.wikipedia.org/wiki/Executable_and_Linkable_Format">ELF</Link>, in the case of *nix systems).</P>
