...
`
      ...
      <Itemize>
        ...
        <Item><Code>set tabstop=4</Code>, <Code>set softtabstop=4</Code>, and <Code>set shiftwidth=4</Code> together configure Vim so that tabs are visually represented as four spaces. They also assist the <Code>autoindent</Code> feature, specifying exactly <It>how</It> a level of indentation should be represented. Finally, they make it so that Vim commands that shift over by a level of indentation will shift over by four spaces. You can replace 4 with another number if you want your tabs to be shorter or longer.</Item>
      </Itemize>
