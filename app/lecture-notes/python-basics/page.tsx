...
`
      ...
      <P>But in Python, "list" has another meaning. In Python, <Term>List</Term> is actually a data type. That's to say, you can create <Code>int</Code> variables, you can create <Code>bool</Code> variables, and so on, but you can also create <Code>List</Code> variables.</P>
