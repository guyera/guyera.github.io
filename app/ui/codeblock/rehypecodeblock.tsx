...
async function RehypeCodeBlock({ code, language, fileName, highlightLines='', showLineNumbers=false, diff=false }: { code: string, language: string, fileName?: string, highlightLines?: string, showLineNumbers?: boolean, diff?: boolean }) {
