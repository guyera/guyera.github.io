...
`
      ...
      <P>For the most part, the module scope works just like any other scope. Any symbols that are created within the module scope can also be accessed within the module scope at any point after it's created. For example, our <Code>main()</Code> function is defined in the module scope, which is why we're able to call it from within the if statement at the bottom of our program (which is also a part of the module scope).</P>
