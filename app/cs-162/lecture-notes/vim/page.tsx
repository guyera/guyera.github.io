...
async function LectureNotes({ allPathData }: { allPathData: any }) {
  return (
    <>
      ...
      <P>Vim has its quirks, but it's also very powerful if you know how to use it. You will often find yourself editing files on a remote system and Vim almost always available, so it is very useful to have at least a basic familiarity with it. And for the advanced features that IDEs support out-of-the-box (e.g., frontend linters to detect and highlight syntax errors), there are Vim plugins for that (e.g., <Link href="https://github.com/dense-analysis/ale">this one</Link>).</P>
