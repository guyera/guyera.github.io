...
async function LectureNotes({ allPathData }: { allPathData: any }) {
  return (
    <>
      ...
      <P>So, a given program might store <It>lots</It> of data that doesn't need to be resized and can reasonably be freed in LIFO order. This kind of data can often be stored on the stack without any issues, and the stack is very performant and easy to navigate, so this kind of data is a good candidate for stack storage. And indeed, many programming languages use the stack to store this kind of data (we'll talk about how Python uses the stack <Link href="#pythons-memory-model">in a bit</Link>).</P>
